...
if (!function_exists('qode_styles')) {
    function qode_styles() {
		...
		if (file_exists(dirname(__FILE__) ."/css/style_dynamic.css") && qode_is_css_folder_writable()) {
        ...
        if ($responsiveness != "no"):
			...
			if (file_exists(dirname(__FILE__) ."/css/style_dynamic_responsive.css") && qode_is_css_folder_writable())
		...
		if (file_exists(dirname(__FILE__) ."/css/custom_css.css") && qode_is_css_folder_writable())
...
if (!function_exists('qode_scripts')) {
    function qode_scripts() {
		...
		if (file_exists(dirname(__FILE__) ."/js/default_dynamic.js") && qode_is_js_folder_writable()) {
		...
		if (file_exists(dirname(__FILE__) ."/js/custom_js.js") && qode_is_js_folder_writable()) {
